...
<div class="header" style="background-color: #3a4b59; padding: 20px; color: white; display: flex; align-items: center; justify-content: space-between; margin-left: -130px;">
    <nav style="margin-left: 200px;">
        <a href="/do_An/admin/chiTietKS/thongTinKhachSan" class="nav-link active" style="color: white; margin: 0 10px; text-decoration: none; padding: 8px; border-radius: 4px;">Thông tin khách sạn</a>
        ...
        <div class="dropdown">
            <a href="#" class="nav-link" style="color: white; margin: 0 10px; text-decoration: none; padding: 8px; border-radius: 4px;">Phòng</a>
