...
<body>
	<div style="padding: 20px;">
        ...
        <section style=" margin-left: 250px; margin-top: 100px; max-width: 500px; background-color: white; padding: 20px; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
            ...
            <form action="${pageContext.request.contextPath}/admin/chiecKhau/insert" method="post">
                ...
                <input type="number" id="discount-amount" name="discount-amount" placeholder="Nhập % chiếc khấu" 
