...
<div style="padding: 20px;">
        <section style=" margin-left: 250px; margin-top: 10px; max-width: 500px; background-color: white; padding: 20px; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
            <h2 style="color: #007BFF; margin-bottom: 15px;">Tạo loại khách sạn mới</h2>
            <form action="${pageContext.request.contextPath}/admin/loaiKhachSan/insert" method="post" enctype="multipart/form-data">
                <label for="diadiem" style="display: block; margin-bottom: 5px;">Tên loại khách sạn:</label>
				<input type="text" id="ten" name="ten" placeholder="Nhập tên loại khách sạn" 
