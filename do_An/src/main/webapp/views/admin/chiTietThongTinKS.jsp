...
<body >
	<%@ include file="/commons/admin/headerThongTinKS.jsp"%>
	<div style="max-width: 800px; padding: 20px; background-color: #fff; border: 1px solid #ddd; border-radius: 8px; margin-left: 80px;">
