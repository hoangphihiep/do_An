...
<!-- Table -->
    ...
    <a href="<c:url value='/admin/loaiKhachSan/add'/>" style="background-color: #0071c2; margin-top: 20px; margin-right: 20px; color: white; padding: 10px 20px; border: none; border-radius: 5px; font-size: 14px; cursor: pointer; float: right; display: inline-block; text-decoration: none;">Thêm loại khách sạn</a>
        ...
        <table id="reservationTable" style="width: 100%; border-collapse: collapse;">
            <thead>
                <tr style="background-color: #f8f9fa; border-bottom: 2px solid #ddd;">
                    ...
                    <th style="padding: 10px; text-align: left; width: 150px; border-right: 1px solid #ddd;">Tên loại khách sạn</th>
                    <th style="padding: 10px; text-align: left; width: 200px; border-right: 1px solid #ddd;">Mô tả</th>
                    <th style="padding: 10px; text-align: left; width: 300px; border-right: 1px solid #ddd;">Ảnh loại khách sạn</th>
            ...
            <tbody>
                <!-- Mẫu mã giảm giá -->
                <c:forEach items="${listloaiks}" var="loaiks" varStatus="STT">
                    <tr style="border-bottom: 1px solid #ddd;">
                        <td style="padding: 10px; border-right: 1px solid #ddd;">${STT.index+1}</td>
                        <td style="padding: 10px; border-right: 1px solid #ddd;">${loaiks.ten}</td>
                        <td style="padding: 10px; border-right: 1px solid #ddd;">${loaiks.moTa}</td>
                        ...
                        <td style="padding: 10px; border-right: 1px solid #ddd;">${loaiks.soKhachSan}</td>

                        <td style="padding: 10px; border-right: 1px solid #ddd;">
                            <a href="<c:url value='/admin/loaiKhachSan/edit?id=${loaiks.id}'/>"
                                ...
                                sửa</a>
                            <a href="<c:url value='/admin/loaiKhachSan/delete?id=${loaiks.id}'/>"
