...
<div style="padding: 20px;">
        ...
        <section style=" margin-left: 250px; margin-top: 10px; max-width: 500px; background-color: white; padding: 20px; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
            <h2 style="color: #007BFF; margin-bottom: 15px;">Sửa loại khách sạn</h2>
            <form action="${pageContext.request.contextPath}/admin/loaiKhachSan/update" method="post" enctype="multipart/form-data">
            	<input type="text" name ="id" value="${loaiKS.id}" hidden="hidden"> 
                <label for="loaiks" style="display: block; margin-bottom: 5px;">Tên loại khách sạn:</label>
				<input type="text" id="ten" name="ten" value ="${loaiKS.ten}" 
				...
				<input type="text" id="mota" name="mota" value ="${loaiKS.moTa}"  
                    style="width: 97%; padding: 10px; margin-bottom: 15px; border: 1px solid #ddd; border-radius: 5px;">
